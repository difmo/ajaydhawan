    ...
    <div>
      ...
      <div className="px-4 mx-auto my-8 lg:px-14 max-w-screen-2xl" id="product">
        <div className="flex flex-col items-center justify-between gap-12 mx-auto md:w-11/12 md:flex-row">
          <div>
            <img className="w-[600px]" src={img} alt="Product" />
          </div>
      ...
      <div className="px-4 max-w-screen-2xl lg:px-14 mx-auto bg-[#000000] py-16">
        ...
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          <div>
            <img src={img4} alt="Third Party Payroll" />
          </div>
          ...
          <div>
            ...
            <div>
              <div className="flex flex-wrap items-center gap-8">
                <img src={man1} className="h-20 cursor-pointer" alt="Customer 1" />
                <img src={man2} className="h-20 cursor-pointer" alt="Customer 2" />
                <img src={man3} className="h-20 cursor-pointer" alt="Customer 3" />
                <img src={man4} className="h-20 cursor-pointer" alt="Customer 4" />
                <img src={man5} className="h-20 cursor-pointer" alt="Customer 5" />
